...
{
        printf("refclock: %u\n", dev->refclock);
        printf("refclock_checked: %d\n", dev->refclock_checked);
        printf("rx_hostfmt: %d\n", dev->rx_hostfmt);
        printf("rx_busfmt: %d\n", dev->rx_busfmt);
        printf("rx_fefmt: %d\n", dev->rx_fefmt);
        printf("rxinit: %d\n", dev->rxinit);
        printf("rx_samples: %ld\n", dev->rx_samples);
        printf("rx_scale_16: %f\n", dev->rx_scale_16);
        printf("rxbuf_total: %u\n", dev->rxbuf_total);
        printf("rxbuf_processed: %u\n", dev->rxbuf_processed);
        printf("rxbuf_processed_ts: %ld\n", dev->rxbuf_processed_ts);
        printf("rxbuf_ts: %lu\n", dev->rxbuf_ts);
        printf("rxbuf_conv_state: %lu\n", dev->rxbuf_conv_state);
        printf("rxbuf_len_iq_symbol: %u\n", dev->rxbuf_len_iq_symbol);
        printf("rxbuf_len_iq_host_sym: %u\n", dev->rxbuf_len_iq_host_sym);
        printf("rx_run: %u\n", dev->rxbuf_len_iq_host_sym);
        printf("rx_chans_in_stream: %u\n", dev->rx_chans_in_stream);
        printf("txinit: %u\n", dev->txinit);
        printf("tx_hostfmt: %d\n", dev->tx_hostfmt);
        printf("tx_busfmt: %d\n", dev->tx_busfmt);
        printf("tx_fefmt: %d\n", dev->tx_fefmt);
        printf("tx_scale_16: %f\n", dev->tx_scale_16);
        printf("txbuf_total: %d\n", dev->txbuf_total);
        printf("txbuf_processed: %d\n", dev->txbuf_processed);
        printf("txbuf_processed_ts: %lu\n", dev->txbuf_processed_ts);
        printf("txbuf_conv_state: %lu\n", dev->txbuf_conv_state);
        printf("txbuf_len_iq_symbol: %u\n", dev->txbuf_len_iq_symbol);
        printf("txbuf_len_iq_host_sym: %u\n", dev->txbuf_len_iq_host_sym);
        printf("txburt_late_prev: %u\n", dev->txburt_late_prev);
        printf("txskip_time: %lu\n", dev->txskip_time);
        printf("tx_run: %u\n", dev->tx_run);
        printf("tx_chans_in_stream: %u\n", dev->tx_chans_in_stream);
        printf("tx_pkt_samples: %u\n", dev->tx_pkt_samples);
        printf("tx_bandwidth: %f\n", dev->tx_bandwidth);
        printf("rx_bandwidth: %f\n", dev->rx_bandwidth);
        //printf("rx_host_filter[0]: %f\n", dev->rx_host_filter[0]);
        //printf("rx_host_filter[1]: %f\n", dev->rx_host_filter[1]);
        //printf("tx_host_filter[0]: %f\n", dev->tx_host_filter[0]);
        //printf("tx_host_filter[1]: %f\n", dev->tx_host_filter[1]);
        printf("tx_host_inter: %d\n", dev->tx_host_inter);
        printf("rx_host_decim: %d\n", dev->rx_host_decim);
        printf("gpio_cfg_funcs: %d\n", dev->gpio_cfg_funcs);
        printf("gpio_cfg_dir: %d\n", dev->gpio_cfg_dir);
        printf("gtime_start: %ld\n", dev->gtime_start);
}
